...
/*
    ...
    */
    function isValidate(obj){//obj는 form객체
      ...
      if(frmObj.password.value.length==0){
        alert("비밀번호를 입력하세요");
        frmObj.password.focus();
        return false;
      }
      if(frmObj.password2.value.length==0){
        alert("비밀번호 확인을 입력하세요");
        frmObj.password2.focus();
        return false;
      }
      else{
    ...
    function fnNoSubmitButton(obj){
        console.log(obj);
        if(obj === undefined)//obj가 폼 객체가 아닌경우
